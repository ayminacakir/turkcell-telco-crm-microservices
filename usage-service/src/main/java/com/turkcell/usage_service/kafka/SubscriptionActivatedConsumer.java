...
import com.turkcell.usage_service.service.QuotaService;
...
public class SubscriptionActivatedConsumer {
    ...
    @KafkaListener(topics = "subscription.activated", groupId = "usage-service-group")
    public void consumeSubscriptionActivated(String payload) {
        ...
        try {
            ...
            quotaService.createQuotaForSubscription(event);
