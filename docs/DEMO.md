...
- **Kullanımım**: kullanım analitiği (grafikler)
- **Esnek Paket / Mağaza**: paket oluşturucu + dijital servis mağazası (görsel demo)
- **Faturalarım / Taleplerim**: gerçek fatura ve ticket verisi; yeni talep gerçek POST
