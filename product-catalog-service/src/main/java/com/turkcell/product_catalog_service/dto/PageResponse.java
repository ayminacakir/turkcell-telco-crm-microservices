 ...
 * degisebildigi icin bu sabit zarf kullanilir. Diger servislerdeki PageResponse ile
 * ayni sekildedir — sozlesme docs/event-contracts.md ile ayni disiplinde korunur.
 */
