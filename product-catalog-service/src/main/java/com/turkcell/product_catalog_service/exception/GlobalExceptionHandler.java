...
/**
 * Doküman standardına göre (Bölüm 12) tüm hatalar RFC 7807 Problem Details
 * formatında dönülür. correlationId gateway tarafından enjekte edilene kadar
 * burada üretilip response'a eklenir.
 */
